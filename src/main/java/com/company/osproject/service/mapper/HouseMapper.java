...
public class HouseMapper{
    ...
    public HouseDto toDtoWithParams(House house){
        return HouseDto.builder()
                ...
                .imageId(house.getImageId())
                .customerId(house.getCustomerId())
                .address(this.addressMapper.toDto(house.getAddress()) == null ? null : this.addressMapper.toDto(house.getAddress()))
//                .sale(this.saleMapper.toDto(house.getSale()) == null ? null : this.saleMapper.toDto(house.getSale()))
//                .rent(this.rentMapper.toDto(house.getRent()) == null ? null : this.rentMapper.toDto(house.getRent()))
//                .images(house.getImages().stream().map(this.imageMapper::toDto).collect(Collectors.toList()))
//                .customers(this.customerMapper.toDto(house.getCustomers()) == null ? null : this.customerMapper.toDto(house.getCustomers()))
                .createdAt(house.getCreatedAt())
                .updatedAt(house.getUpdatedAt())
                .deletedAt(house.getDeletedAt())
                .build();
